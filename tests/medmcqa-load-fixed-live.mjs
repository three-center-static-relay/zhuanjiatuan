...
console.log(JSON.stringify({ok:true,suite:"medmcqa-upload-probe-no-count",paid_call:false,total:b.total,bytes:b.bytes,blob_sha:b.blob_sha,first_id:b.first_id,last_id:b.last_id}));
