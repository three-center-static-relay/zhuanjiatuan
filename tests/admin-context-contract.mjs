...
console.log(JSON.stringify({ok:true,suite:"expert-admin-context-contract",read_only:true,internal_only:true,version_metadata:true,request_scoped_panel_budget:true,soft_cost_length:true,no_token_cap:true,tools_forbidden:true,semantic_profile:"ai-gateway",gateway_step_observed:true,final_synthesis_quality_gate:true,hidden_reasoning_scrub:true,expert_one_direct_final:false}));
