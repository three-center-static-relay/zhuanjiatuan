...
console.log(JSON.stringify({ok:true,suite:"cloudflare-build-gate-contract",worker:wrangler.name,preview_is_local_validation:true,secret:"AI_GATEWAY_TOKEN",dynamic_panel_v2:true}));
